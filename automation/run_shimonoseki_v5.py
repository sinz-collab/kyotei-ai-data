...
REPO = HERE.parent
ENGINE_DIR = REPO / "engines" / "shimonoseki_v5"
if str(REPO) not in sys.path:
    sys.path.insert(0, str(REPO))

from engines.shimonoseki_v5.shimonoseki_engine_v5 import ShimonosekiSiteEngineV5, ENGINE_ID, ENGINE_VERSION
...
def main() -> int:
    ...
    engine = ShimonosekiSiteEngineV5(args.master_dir)
    ...
    if not ok:
        raise RuntimeError(f"Shimonoseki v5 payload invalid: {reason}")
